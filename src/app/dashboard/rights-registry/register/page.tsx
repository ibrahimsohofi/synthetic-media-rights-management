              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox
                    id="ai-training"
                    checked={aiOptOut}
                    onCheckedChange={(checked) => setAiOptOut(checked as boolean)}
                  />
                  <div className="grid gap-1.5 leading-none">
                    <div className="flex items-center gap-2">
                      <Label htmlFor="ai-training" className="font-medium cursor-pointer">
                        Opt out of AI training
                      </Label>
                      <AITrainingBadge />
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Signal that your work should not be used to train AI models
                    </p>
                  </div>
                </div>
